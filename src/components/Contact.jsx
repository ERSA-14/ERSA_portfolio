...
export const Contact = () => {
		...
		>
			...
			>
				...
				<button
					type="submit"
					disabled={isSending}
					className="cosmic-button w-fit flex items-center justify-center gap-2 mt-2 mx-auto !px-6 !py-2 !text-sm disabled:opacity-70 disabled:cursor-not-allowed"
				>
	...
	return (
		<section id="Contact" className="relative bg-secondary/30">
			<div className="container mx-auto max-w-7xl pb-2 mt-0">
				<h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
					<span className="text-primary">Connect</span> with Me
				</h2>
				<p className="text-center text-lg md:text-xl text-muted-foreground mb-12 max-w-4xl lg:max-w-5xl mx-auto">
					Actively{" "}
				...
				<div className="grid grid-cols-1 min-[600px]:grid-cols-2 lg:grid-cols-3 gap-8">
					...
					<div className="min-[600px]:col-span-1 lg:col-span-2">
						<div className="relative bg-card/80 rounded-2xl px-6 py-8 shadow-sm transition-all duration-300 h-full flex flex-col">
							<div
								className={`grid gap-6 md:gap-8 transition-all duration-300 flex-1 ${itemsPerSlide === 2 ? "grid-cols-2" : "grid-cols-1"
									}`}
							>
								{visibleSlides}
							</div>
			...
			<p className="flex items-center justify-center gap-3 text-center text-muted-foreground text-sm mt-6 pb-2 italic font-bold">
