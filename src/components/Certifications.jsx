...
const certifications = [
	{
		...
		icon: <FaAws className="w-10 h-10 md:w-8 md:h-8" />,
		description:
	...
	},
	{
		...
		icon: (
			<OracleIcon className="w-10 h-10 md:w-8 md:h-8 text-primary" />
		),
		description:
						...
						{visibleCerts.map((cert, index) => (
							...
							>
								...
								<div className="relative z-10 flex-1 text-center md:text-left flex flex-col justify-center gap-0">
									<div>
										<span className="text-sm md:text-base font-bold tracking-[.2em] uppercase opacity-80 leading-none font-['Roboto_Mono']">
											{cert.issuer}
										</span>
									</div>
									...
									<p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-1 font-medium font-['Space_Grotesk'] italic max-w-3xl">
										{cert.description}
									</p>

									<div className="flex flex-wrap items-center justify-center md:justify-start gap-4 font-['Inter']">
										<span className="px-2 py-0.5 border-1 border-primary bg-primary/20 text-primary text-sm md:text-base font-bold rounded uppercase border border-primary/10">
											Active
										</span>
										<span className="text-sm md:text-base font-bold text-muted-foreground/80 tracking-wide uppercase">
